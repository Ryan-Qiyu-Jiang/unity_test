...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    bool m_NavAgentResumeState = false;
    ...
    void GroundCheck()
    {
        ...
        if (Time.time >= m_LastTimeJumped + k_JumpGroundingPreventionTime)
        {
            ...
            if (Physics.CapsuleCast(GetCapsuleBottomHemisphere(), 
                                    ...
                                    m_Controller.radius, Vector3.down, 
                                    out RaycastHit hit, chosenGroundCheckDistance, 
    ...
    public void PauseNavAgent() {
        m_NavAgentResumeState = m_NavAgent.isStopped;
        m_NavAgent.isStopped = true;
    }

    public void ResumeNavAgent() {
        m_NavAgent.isStopped = m_NavAgentResumeState;
    }
}
